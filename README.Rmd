...
`mimosa` is an R package based on the paper: [MIMoSA: A Method for Inter-Modal Segmentation Analysis by Valcarcel et al.](http://onlinelibrary.wiley.com/doi/10.1111/jon.12506/full). This package creates data structures necessary for training and testing and then allows the user to train a model and then apply the trained model to generate probability maps and predicted lesion segmentations.
