...
test_dir = file.path(data_dir, "test01")
...
filepaths = data.frame(T1 = T1_files, T2 = T2_files, FLAIR = FLAIR_files, PD = PD_files, stringsAsFactors = FALSE)
filepaths
...
train2_dir = file.path(data_dir, "training02")
